...
#define STATUS_DEVICE_NAME_MAX_LEN  32      // Maximum length of device name
 ...
 * Device name is loaded from Preferences, or generated as "BAZA_XXXXXXX" if not saved
 ...
 * @return Pointer to the device name string (do not free)
 */
